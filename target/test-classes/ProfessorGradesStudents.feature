...
Then  ponderated grade is calculated based on the
      grader "category" and "status". 
...
Given I asked for a total average
When peer and proffessors grades by status were calculated
